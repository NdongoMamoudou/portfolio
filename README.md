...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="width: 50%; text-align: center; vertical-align: top; padding: 10px;">
      <img src="Images/G_aosis1.png" alt="GP Colis Screenshot" style="width: 100%; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
    </td>
    <td style="width: 50%; padding: 10px;">
      <strong>
        <a href="https://github.com/NdongoMamoudou/gp_colis" style="text-decoration: none; font-size: 1.2em; color: #2c3e50;">GP Colis - Gestion des Colis entre le Sénégal et la France</a>
      </strong>
      <p style="font-size: 1em; color: #7f8c8d; line-height: 1.6; margin-top: 10px;">
        **GP Colis** est une application web dédiée à la gestion et à la publication d'annonces pour l'envoi ou la réception de colis entre le Sénégal et la France. Les utilisateurs peuvent publier des annonces, consulter celles des autres et organiser des envois de colis.
      </p>
      <p><strong>Fonctionnalités principales :</strong></p>
      <ul style="font-size: 1em; color: #34495e; line-height: 1.6;">
        <li>Création de comptes, publication d'annonces de colis, validation des informations.</li>
        <li>Affichage dynamique des villes via API.</li>
      </ul>
      <p><strong>Technologies utilisées :</strong> React.js, Node.js, Axios, API REST, Nginx (Reverse Proxy), HTML5, CSS3.</p>
    </td>
  </tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="width: 50%; text-align: center; vertical-align: top; padding: 10px;">
      <img src="Images/spam.PNG" alt="Icône d'email" style="width: 100%; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
    </td>
    <td style="width: 50%; padding: 10px;">
      <strong>
        <a href="https://github.com/NdongoMamoudou/Deep_Learning_pour_la_Classification_Binaire" style="text-decoration: none; font-size: 1.2em; color: #2c3e50;">Classification : Emails (Spam) et Cancer</a>
      </strong>
      <p style="font-size: 1em; color: #7f8c8d; line-height: 1.6; margin-top: 10px;">
        Ce projet regroupe deux tâches de classification binaire : la détection des emails spam et la prédiction du cancer à l'aide de modèles de Deep Learning.
      </p>
    </td>
  </tr>
</table>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="width: 50%; text-align: center; vertical-align: top; padding: 10px;">
      <img src="Images/finance.PNG" alt="Icône Marketing" style="width: 100%; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
    </td>
    <td style="width: 50%; padding: 10px;">
      <strong>
        <a href="https://github.com/NdongoMamoudou/analyse-donnees_fraude-marketing" style="text-decoration: none; font-size: 1.2em; color: #2c3e50;">Analyse des Comportements d'Achat des Clients - Campagne Marketing</a>
      </strong>
      <p style="font-size: 1em; color: #7f8c8d; line-height: 1.6; margin-top: 10px;">
        Ce projet explore les comportements d'achat des clients à partir des données de campagnes marketing. L'analyse explore les habitudes d'achat et applique une segmentation des clients selon leurs revenus et dépenses.
      </p>
    </td>
  </tr>
</table>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="width: 50%; text-align: center; vertical-align: top; padding: 10px;">
      <img src="Images/web_scraping.PNG" alt="web scraping" style="width: 100%; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
    </td>
    <td style="width: 50%; padding: 10px;">
      <strong>
        <a href="https://github.com/NdongoMamoudou/WebScrapingCollection" style="text-decoration: none; font-size: 1.2em; color: #2c3e50;">Web Scraping Collection</a>
      </strong>
      <p style="font-size: 1em; color: #7f8c8d; line-height: 1.6; margin-top: 10px;">
        Un projet d'extraction automatisée de données à partir de sites web pour collecter des informations structurées et les analyser.
      </p>
      <p><strong>Technologies utilisées :</strong> Python, BeautifulSoup, Scrapy, Selenium, Requests, Pandas.</p>
    </td>
  </tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="width: 50%; text-align: center; vertical-align: top; padding: 10px;">
      <img src="Images/seismic.PNG" alt="Analyse Sismique Screenshot" style="width: 100%; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
    </td>
    <td style="width: 50%; padding: 10px;">
      <strong>
        <a href="https://github.com/NdongoMamoudou/seismic-data-analysis" style="text-decoration: none; font-size: 1.2em; color: #2c3e50;">Analyse et Traitement des Données Sismiques avec Hadoop, Hive et Spark</a>
      </strong>
      <p style="font-size: 1em; color: #7f8c8d; line-height: 1.6; margin-top: 10px;">
        Ce projet Big Data analyse de grands volumes de données sismiques en utilisant Hadoop, Hive et Spark pour détecter les événements sismiques et observer des tendances.
      </p>
      <p><strong>Technologies utilisées :</strong> Docker, Hadoop (HDFS), Hive, Spark, Kafka, Apache Superset, Echarts.</p>
    </td>
  </tr>
